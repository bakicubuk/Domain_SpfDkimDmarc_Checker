...
<#>
HelpInfoURI 'https://github.com/bakicubuk/Domain_SpfDkimDmarc_Checker/blob/main/public/CmdletYardim/Get-DMARCRecord.md'
#>
...
function Get-DMARCRecord {
    ...
    param(
        [Parameter(
            ...
            HelpMessage = "DMARC kaydinin sorgulanacagi domain adini belirtir."
        )][string[]]$Name,
