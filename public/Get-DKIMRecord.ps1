...
<#>
HelpInfoURI 'https://github.com/bakicubuk/Domain_SpfDkimDmarc_Checker/blob/main/public/CmdletYardim/Get-DKIMRecord.md'
#>
...
function Get-DKIMRecord {
    ...
    param(
        [Parameter(
            ...
            HelpMessage = "DKIM kaydinin sorgulanacagi domain adini belirtir.")]
        [string[]]$Name,
    ...
    begin {
        ...
        # Denenecek yaygin DKIM selector listesi
        # (Selector belirtilmezse bu listedeki adlar sirayla denenir)
