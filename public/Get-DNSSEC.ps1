...
<#>
.HelpInfoURI 'https://github.com/bakicubuk/Domain_SpfDkimDmarc_Checker/blob/main/public/CmdletYardim/Get-DNSSec.md'
#>
...
function Get-DNSSec {
    ...
    param(
        [Parameter(
            ...
            HelpMessage = "DNSSEC varliginin test edilecegi domain adini belirtir.")]
        [string[]]$Name,
